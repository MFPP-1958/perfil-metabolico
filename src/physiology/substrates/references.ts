export const SUBSTRATE_MODEL_VERSION = 'substrate-metabolism@1.0.0';
...
export const SUBSTRATE_LIMITATIONS = [
  ...
  'El modelo agota la oxidación de grasas exactamente en el MLSS. En la realidad conserva una contribución pequeña por encima de ese punto.',
